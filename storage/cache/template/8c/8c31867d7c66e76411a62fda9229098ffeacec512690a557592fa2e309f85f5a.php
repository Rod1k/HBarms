...
class __TwigTemplate_ce6e7a97dd30c1f91c14a84d4c7e7b6988115fd6e0ebba5d47e4d87e6553f7d0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
var image_row = ";
    ...
    function addImage(language_id) {
      ...
      html += '  <td class=\"text-left\"><input type=\"text\" name=\"banner_image[' + language_id + '][' + image_row + '][title]\" value=\"\" placeholder=\"";
        ...
        echo ($context["entry_title"] ?? null);
        echo "\" class=\"form-control\" /></td>';
      html += '  <td> <input type=\"text\" name=\"banner_image[' + language_id + '][' + image_row + '][title_after]\" value=\"\" class=\"form-control\" /> </td>';
      html += '  <td> <input type=\"text\" name=\"banner_image[' + language_id + '][' + image_row + '][description]\" value=\"\" class=\"form-control\" /> </td>';
      html += '  <td> <input type=\"text\" name=\"banner_image[' + language_id + '][' + image_row + '][name_button]\" value=\"\" class=\"form-control\" /> </td>';
